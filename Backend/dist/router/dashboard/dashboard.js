...
dashboardRoute.get("/doctor", (0, authMiddleware_1.default)("doctor"), (req, res) => {
    res.json({ message: `Welcome, Dr. ${req.user.name}` });
});
// Only patients can access this route
dashboardRoute.get("/patient", (0, authMiddleware_1.default)("patient"), (req, res) => {
    res.json({ message: `Welcome, ${req.user.name}` });
});
// Admin route
dashboardRoute.get("/admin", (0, authMiddleware_1.default)("admin"), (req, res) => {
